...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 14.0, 184.0, 100.0, 36.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 14.0, 156.0, 100.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"lockeddragscroll" : 0,
									"maxclass" : "bpatcher",
									"name" : "Mouse Location Main.maxpat",
									"numinlets" : 0,
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "Mouse Location Main.maxpat",
				"bootpath" : "C:/ProgramData/Chuck/main/Modules/Mouse Location",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
