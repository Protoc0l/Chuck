...
, 							{
								"box" : 								{
									...
									"lockeddragscroll" : 0,
									"maxclass" : "bpatcher",
									"name" : "Spherical Equivalent Calculator.maxpat",
									"numinlets" : 0,
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 136.0, 13.0, 870.0, 159.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 0.0, -1.0, 870.0, 159.0 ],
									"viewvisibility" : 1
								}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "Spherical Equivalent Calculator.maxpat",
				"bootpath" : "c:/ProgramData/Chuck/main/Modules/Spherical Equivalent Calculator",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
