...
,
		"classnamespace" : "box",
		"openrect" : [ 192.0, 194.0, 101.0, 43.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 156.0, 196.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "wclose" ],
					"patching_rect" : [ 156.0, 168.0, 100.0, 22.0 ],
					"text" : "t wclose"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 36.0, 168.0, 109.0, 50.0 ],
					"text" : "s hide_right_click_OWL"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 348.0, 73.5, 105.0, 36.0 ],
					"text" : "s COMP_ALITEMO"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 348.0, 25.0, 92.359375, 39.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 23.0, 101.0, 19.4990234375 ],
					"text" : "Completed",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 206.5, 73.5, 100.0, 36.0 ],
					"text" : "s NEW_ALITEMO"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 206.5, 25.0, 101.0, 39.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 20.0, 78.0, 121.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 20.0, 52.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 20.0, 105.0, 67.0, 22.0 ],
					"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
					"text" : "thispatcher"
				}
