...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "open" ],
					"patching_rect" : [ 51.0, 73.0, 42.0, 22.0 ],
					"text" : "t open"
				}
...
,
						"classnamespace" : "box",
						"openrect" : [ 36.0, 87.0, 718.0, 466.0 ],
						"bglocked" : 0,
						"openinpresentation" : 1,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 16.5, 228.0, 115.0, 22.0 ],
									"text" : "\"Lens Calculations\""
								}
...
, 							{
								"box" : 								{
									...
									"lockeddragscroll" : 0,
									"maxclass" : "bpatcher",
									"name" : "Lens Calculations.maxpat",
									"numinlets" : 0,
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 150.0, 56.0, 718.0, 469.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 0.0, -1.0, 719.0, 470.0 ],
									"viewvisibility" : 1
								}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 237.0, 191.0, 131.0, 22.0 ],
													"text" : "title \"Lens Calculations\""
												}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "Lens Calculations.maxpat",
				"bootpath" : "C:/ProgramData/Chuck/main/Modules/Lens Calculations",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
