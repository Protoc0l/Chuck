...
,
		"classnamespace" : "box",
		"openrect" : [ 45.0, 104.0, 184.0, 158.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 101.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 5.0, 41.0, 111.0, 22.0 ],
					"text" : "route 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 51.0, 101.0, 51.0, 22.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "close" ],
					"patching_rect" : [ 5.0, 73.0, 43.0, 22.0 ],
					"text" : "t close"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 51.0, 7.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 51.0, 73.0, 128.0, 22.0 ],
					"text" : "t open b"
				}
...
,
						"classnamespace" : "box",
						"openrect" : [ 42.0, 87.0, 756.0, 679.0 ],
						"bglocked" : 0,
						"openinpresentation" : 1,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 16.5, 179.0, 24.0, 24.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 716.0, -4.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 16.5, 228.0, 115.0, 36.0 ],
									"text" : "\"Contact Lens Compendium\""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 16.5, 204.0, 100.0, 22.0 ],
									"text" : "select 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 16.5, 155.0, 100.0, 22.0 ],
									"text" : "loadmess 0"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 16.5, 283.0, 100.0, 22.0 ],
									"text" : "s Launch"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 84.0, 109.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"lockeddragscroll" : 0,
									"maxclass" : "bpatcher",
									"name" : "Contact Lens Compendium.maxpat",
									"numinlets" : 0,
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 150.0, 56.0, 718.0, 469.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 0.0, -1.0, 756.0, 680.0 ],
									"viewvisibility" : 1
								}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 237.0, 191.0, 180.0, 22.0 ],
													"text" : "title \"Contact Lens Compendium\""
												}
...
,
					"patching_rect" : [ 51.0, 129.0, 118.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "Contact Lens Compendium.maxpat",
				"bootpath" : "C:/ProgramData/Chuck/main/Modules/Contact Lens Compendium",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
