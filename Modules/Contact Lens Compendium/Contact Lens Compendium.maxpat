...
,
		"classnamespace" : "box",
		"openrect" : [ 42.0, 125.0, 756.0, 679.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 174.0, 10.0, 725.0, 629.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 1.0, 753.0, 677.0 ],
					"rendermode" : 0,
					"url" : "https://compendium.contactlensupdate.com/ca/contact_lens/search/advanced"
				}
